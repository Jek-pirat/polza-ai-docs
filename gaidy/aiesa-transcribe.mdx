...
| Диаризация | Да, всегда включена — поле `segments` |
...
<AccordionGroup>
  ...
  <Accordion title="Как долго живёт результат" icon="clock-rotate-left">
    Текст и сегменты хранятся у нас и остаются доступны по `id` неограниченно долго. Повторно скачивать или кэшировать расшифровку на своей стороне не обязательно.
  </Accordion>
